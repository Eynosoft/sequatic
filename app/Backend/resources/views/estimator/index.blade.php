        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" class="form-horizontal" name="salesrep_form" action="{{url("backend/estimator/create")}}" id="salesrep_form" method="post">
                        <div class="col-lg-12">
                            <div class="form-group">
...
<div aria-hidden="true" aria-labelledby="myModalLabel" data-backdrop="static" data-easein="expandIn" role="dialog" tabindex="-1" id="editSales-rep" class="modal fade modal-style">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button aria-hidden="true" data-dismiss="modal" class="close" type="button">x</button>
                    <h3 class="modal-title compose-heading">Edit Estimator</h3>
                </div>
...
<script type="text/javascript">
    ...
    function loadEstimator(url) {
        ...
        if (url == 'undefined' || url == '' || url == null) {
            url = '{{url("backend/load-estimator")}}';
        }
        $.ajax({
            url: url,
            type: 'post',
    ...
    function loadEstimatorStatics() {
        var url = '{{url("backend/load-estimator-statics")}}';
        $.ajax({
            url: url,
            type: 'post',
    ...
    function create() {
        ...
        var url = '{{url("backend/estimator/create")}}';
        $.ajax({
            url: url,
            type: 'post',
    ...
    function update() {
        ...
        var url = '{{url("backend/estimator/update")}}';
        $.ajax({
            url: url,
            type: 'post',
    ...
    function loadSalesRepEdit(id) {
        ...
        url = '{{url("backend/estimator/edit")}}/'+id;
        $.ajax({
            url: url,
            type: 'get',
            //data: $('#searchform').serialize(),
