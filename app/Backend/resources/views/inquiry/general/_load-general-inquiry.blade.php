    ...
    <table class="table table-striped table-responsive table-bordered admin_table" style="margin:0px">
        ...
        <tbody>
            ...
            <tr class="">
                ...
                <td>{{$inq->lead_value ? $inq->lead_value : '-' }}</td>
                <td>{{$inq->country['country_name']}}</td>
                <td>{{$inq->general_inquiry_status}}</td>
                <td>02/15/2017</td>

                <td>
                    <ul class="list-inline">
                        <li>
                            <a href="{{url('/backend/inquiry/edit').'/'.$inq->id}}">
                            ...
                            <div class="select">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="#" onclick="toggleInquiryStatus({{$inq->id}}, 'solved', 'general')">Mark as a Solved</a></li>
