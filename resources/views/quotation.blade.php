        ...
        <div class="container">
            <div class="form-cnt">
                <div class="heading clearfix">
                    <h2>Quotation Inquiry Form</h2>
                </div>
                <form role="form" action="{{url('inquiry/choose-panel')}}" method="post" id="general-inquiry-form">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-sm-12 col-xs-12">
                                    <div class="form-group text-center">
                                        ...
                                        <input type="submit" id="submitButton" class="btn btn-primary btn-lg btn-rounded" value="Next">
                                    </div>
                                </div>
                            </div>
                        </div>
