    <form id="general-inquiry-edit-form" name="general-inquiry-edit-form" method="post"  onsubmit="updateInquerydata(this); return false;" >
            ...
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <div class='input-group date'>
                        <input type='text' class="form-control datetimepicker2" id="date_of_inquiry" readonly value="<?php echo e($inquiry->created_at->format('m-d-Y')); ?>" />
            ...
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <div class="input-group date " data-provide="datepicker" >
                        <input type='text' class="form-control datetimepicker2" id="last_change_date" readonly value="<?php echo e($inquiry->updated_at->format('m-d-Y')); ?>" />
                        <span class="input-group-addon">
                            <i class="fa fa-calendar" aria-hidden="true"></i>
                        </span>
                    </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
                    <label>City:</label>
                    <input type="text" class="form-control" name="city" readonly value="<?php echo e($inquiry->city); ?>">    
                </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
                    <label>Zip:</label>
                    <input type="text" class="form-control" name="zipcode" data-masked-input="999999" maxlength="6" readonly value="<?php echo e($inquiry->zipcode); ?>">    
                </div>
            </div>
            ...
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
                    <label>Country:</label>
                    <select class="form-control country_selectpicker" name="country_id" readonly disabled="" id="country_id" value="<?php echo e(old('country_id')); ?>">
        ...
        <div class="row">
            <div class="col-lg-6 col-sm-6 col-xs-12">
                <div class="form-group">
                   ...
                   <input type="text" class="form-control" name="project_name" value="<?php echo e($inquiry->project_name); ?>" readonly  placeholder="Project Name">
                </div>
            </div>
        </div>
