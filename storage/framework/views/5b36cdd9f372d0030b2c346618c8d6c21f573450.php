    ...
    <table class="table table-striped table-responsive table-bordered admin_table" style="margin:0px">
        ...
        <tbody>
            ...
            <tr class="">
                ...
                <td><?php echo e($inq->general_inquiry_status); ?></td>
                <td>02/15/2017</td>
                            ...
                            <div class="select">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="#" data-toggle="modal" data-target=".transfer-sales">Transfer to Sales Manager</a></li>
                                        <li><a href="#">Reply to Inquiry</a></li>
                                        <li><a href="#" onclick="toggleInquiryStatus(<?php echo e($inq->id); ?>, 'solved', 'general')">Mark as a Solved</a></li>
