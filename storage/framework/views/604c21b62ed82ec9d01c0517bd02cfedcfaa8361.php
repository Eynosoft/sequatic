        ...
        <div class="container">
            <div class="quote_icon">
                <ul class="list-inline">
                    <li class="blue-color">
                        <a href="javascript:void(0)" onclick="toggleInquiryStatus(<?php echo e($inquiry->id); ?>, 'Won', 'quotation'); return false;">
                            <i class="fa fa-trophy" aria-hidden="true"></i>
                        </a>
                    </li>
                    <li class="pink-color">
                        <a href="javascript:void(0)" onclick="toggleInquiryStatus(<?php echo e($inquiry->id); ?>, 'Lost', 'quotation'); return false;">
...
<!--                            <span class="icon icon-folder"></span>-->
    ...
    <script type="text/javascript">
        ...
        swal({
        title: 'Are you sure?',
                text: "<?php echo e((" + status + ") ? 'You want to update status!' : ''); ?>",
                type: 'warning',
