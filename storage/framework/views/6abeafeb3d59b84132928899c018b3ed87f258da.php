    ...
    <table class="table table-striped table-responsive table-bordered admin_table" style="margin:0px">
        ...
        <tbody>
            ...
            <tr class="">
                ...
                <td><?php echo e($inq->created_at->format('m/d/Y')); ?></td>
                <td><?php echo e($inq->first_name); ?> <?php echo e($inq->last_name); ?></td>
                <td><?php echo e($inq->email); ?></td>
                <td><?php echo e($inq->mobile); ?></td>
                <td><?php echo e($inq->company_name ? $inq->company_name : '-'); ?></td>
                <td><?php echo e($inq->lead_value ? $inq->lead_value : '-'); ?></td>
                <td><?php echo e(isset($inq->country['country_name']) ? $inq->country['country_name'] : '-'); ?></td>
                <td>02/15/2017</td>

                <td>
                    <ul class="list-inline">
                        <li>
                            <?php $__currentLoopData = $inq->detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                
                                <?php if($detail->quote_id == $inq->id): ?>
                                    <a href="<?php echo e(url('/admin/inquiry-detail/detail-inquiry').'/'.$inq->id); ?>">
