                        ...
                        <table class="table table-striped table-responsive table-bordered admin_table" style="margin:0px">
                            ...
                            <tbody>
                                ...
                                <tr class="">
                                    ...
                                    <td><?php echo e($inq->inquiry->lead_value ? $inq->inquiry->lead_value : '-'); ?></td>
                                    <td><?php echo e($inq->inquiry->country['country_name']); ?></td>
                                                ...
                                                <div class="select">
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a href="#" onclick="createCloneInquiryStatus(<?php echo e($inq->inquiry->id); ?>, 'deleted', 'trash')">Clone</a></li>
