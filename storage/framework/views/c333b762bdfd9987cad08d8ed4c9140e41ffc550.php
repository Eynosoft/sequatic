...
<script src="<?php echo e(asset('../js/velocity.ui.min.js')); ?>"></script>
 <script src="<?php echo e(asset('../js/jquery.masked-input.min.js')); ?>"></script>
<!--<script>
        ...
        title: "Do You Want to add another Panel?",
                ...
                window.location.href = "../choose-panel-type.php";
                }
                });
        };
</script>-->
